...
describe('CollectionCard', () => {
  ...
  it('renders correctly with provided props', () => {
    renderWithMantine(
      <CollectionCard collection={mockCollection()} itemCount={10} onEditClick={mockOnEditClick} />,
    );
  ...
  it('does not show edit button when onEditClick is not provided', () => {
    renderWithMantine(<CollectionCard collection={mockCollection()} itemCount={10} />);
