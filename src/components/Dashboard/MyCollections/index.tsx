...
import { CollectionItemsContextProvider } from '../../../contexts/CollectionItemsContext';
...
const MyCollections: React.FC<MyCollectionsProps> = ({ user }) => {
  ...
  const handleUpdateCollection = async (
    ...
    try {
      ...
      const updatedCollection = await CollectionManagementRequests.updateCollection(
        editingCollection,
        {
          name: data.name,
          is_public: data.isPublic,
        ...
        {(collectionsContext: UserCollectionsContextState) => (
          <div className="my-collections">
            ...
            <CollectionItemsContextProvider
              collectionIds={collectionsContext.loadedData.map((i) => i.id!)}
            >
