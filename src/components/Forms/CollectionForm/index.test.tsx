...
describe('CollectionForm', () => {
  ...
  test('renders form elements correctly', () => {
    render(<CollectionForm onSubmit={mockOnSubmit} onCancel={mockOnCancel} />);
  ...
  test('displays error message when provided', () => {
    ...
    render(<CollectionForm onSubmit={mockOnSubmit} onCancel={mockOnCancel} error={errorMessage} />);
  ...
  test('disables form elements when isSubmitting is true', () => {
    render(<CollectionForm onSubmit={mockOnSubmit} onCancel={mockOnCancel} isSubmitting={true} />);
