                ...
                <Stack gap="md">
                  ...
                  <Box>
                    ...
                    {type === 'email' ? (
                      ...
                      <Text data-testid="template-preview-body" style={{ whiteSpace: 'pre-wrap' }}>
                        {previewBody}
                      </Text>
                    )}
                  </Box>
              ...
              <Tabs.Panel value="default" pt="md">
                <Stack gap="md">
                  <Text size="sm" c="dimmed">
                    In-code default for this template key. Reverting an org override will fall back
                    here (or to a global override if one exists).
                  </Text>
                  <Box>
                    <Text size="xs" c="dimmed" tt="uppercase" fw={600}>
                      {headlineLabel}
                  ...
                  <Box>
                    ...
                    <Code block>{entry.defaultBody || '(empty)'}</Code>
                  </Box>
                </Stack>
              </Tabs.Panel>
            </Tabs>
