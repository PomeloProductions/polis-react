 ...
 * @param params
 */
function runRequest<Model extends BaseModel>(
  endpoint: string,
  page: number,
  expands: string[],
  limit: number,
 ...
 * @param replace
 */
function loadPage<Model extends BaseModel>(
  ...
  return runRequest<Model>(
    ...
    baseContext.search,
    { ...baseContext.params },
  ).then((page: Page<Model>) => {
    const validResult = baseContext.validateResult
      ? baseContext.validateResult(baseContext, page)
      : true;
 ...
 * @param endpoint
 */
function createLoadNextPageCallback<Model extends BaseModel>(
  setContext: Dispatch<SetStateAction<BasePaginatedContextState<Model>>>,
  baseContext: BasePaginatedContextState<Model>,
  endpoint: string,
): () => Promise<Page<Model>> {
 ...
 * @param endpoint
 */
function createRefreshDataCallback<Model extends BaseModel>(
  setContext: Dispatch<SetStateAction<BasePaginatedContextState<Model>>>,
  baseContext: BasePaginatedContextState<Model>,
  endpoint: string,
 ...
 * @param endpoint
 */
function createSetFilterCallback<Model extends BaseModel>(
  setContext: Dispatch<SetStateAction<BasePaginatedContextState<Model>>>,
  baseContext: BasePaginatedContextState<Model>,
  endpoint: string,
 ...
 * @param endpoint
 */
function createSetSearchCallback<Model extends BaseModel>(
  setContext: Dispatch<SetStateAction<BasePaginatedContextState<Model>>>,
  baseContext: BasePaginatedContextState<Model>,
  endpoint: string,
 ...
 * @param endpoint
 */
function createSetOrderCallback<Model extends BaseModel>(
  setContext: Dispatch<SetStateAction<BasePaginatedContextState<Model>>>,
  baseContext: BasePaginatedContextState<Model>,
  endpoint: string,
 ...
 * @param baseContext
 */
function createAddModelCallback<Model extends BaseModel>(
  setContext: Dispatch<SetStateAction<BasePaginatedContextState<Model>>>,
  baseContext: BasePaginatedContextState<Model>,
): (model: Model) => void {
  return (model: Model) => {
 ...
 * @param baseContext
 */
function createRemoveModelCallback<Model extends BaseModel>(
  setContext: Dispatch<SetStateAction<BasePaginatedContextState<Model>>>,
  baseContext: BasePaginatedContextState<Model>,
): (model: Model) => void {
  return (model: Model) => {
 ...
 * @param baseContext
 */
function createGetModelCallback<Model extends BaseModel>(
  baseContext: BasePaginatedContextState<Model>,
