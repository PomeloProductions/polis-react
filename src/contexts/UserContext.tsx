...
export const UserContextProvider: React.FC<PropsWithChildren<UserContextProviderProps>> = ({
  userId,
  skipCache,
  children,
}) => {
        ...
        {(context) =>
          context.hasLoaded ? (
            !context.notFound ? (
              ...
              <div className={'user-not-found'}>Not Found</div>
            )
          ) : (
            <LoadingScreen />
          )
