...
export const SignInContext = React.createContext<SignInContextStateConsumer>(
  createDefaultPhoneVerificationContextState(persistedState),
);
...
const SignInContextProvider: React.FC<PropsWithChildren<SignInContextProviderProps>> = ({
  children,
}) => {
  ...
  return <SignInContext.Provider value={fullContext}>{children}</SignInContext.Provider>;
};
