...
export const SignUpContext = React.createContext<SignUpContextStateConsumer>(
...
const SignUpContextProvider: React.FC<PropsWithChildren<SignUpContextProviderProps>> = ({
  children,
}) => {
  ...
  return <SignUpContext.Provider value={fullContext}>{children}</SignUpContext.Provider>;
};
