    ...
    return (
        <Stack gap="xl">
                        ...
                        <Table.Tbody>
                            {entry.configOptions.map((opt) => (
                                <Table.Tr key={opt.key}>
                                    ...
                                    <Table.Td>
                                        <Code c="violet">
                                            {ConfigTypeLabel[opt.type] ?? opt.type}
                                        </Code>
                                    </Table.Td>
                                    <Table.Td>
            ...
            <Stack gap="sm">
                ...
                <Text size="sm" c="dimmed">
                    These are ready-made config presets you can apply in the Playground or copy
                    directly.
                </Text>
                ...
                {entry.exampleConfigs.length === 1 ? (
                    <Stack gap="sm">
                        ...
                        <ExampleConfigPanel
                            example={entry.exampleConfigs[0]}
                            active
                        />
                    </Stack>
                ) : (
            ...
            <Paper p="xl" radius="md" bg="blue.0" withBorder>
                <Group justify="space-between" align="center" wrap="wrap" gap="md">
                    <div>
                        ...
                        <Text size="sm" c="dimmed">
                            Open the playground to interact with this component using your own
                            data, tweak settings in real time, and add it to any of your pages.
                        </Text>
                    </div>
                    <Group gap="xs">
                        <Button
