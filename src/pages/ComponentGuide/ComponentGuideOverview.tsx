        ...
        <Stack gap="xl">
            ...
            <Stack gap="md">
                ...
                <Text>
                    ...
                    <strong>slug</strong> (URL), a <strong>name</strong>, and a{' '}
                    <strong>type</strong> that controls how it behaves. Pages can be organized
                    into a hierarchy — a parent page can have child pages listed beneath it in
                    the navigation.
                </Text>
                ...
                <Grid>
                    <Grid.Col span={{ base: 12, md: 4 }}>
                        <Paper p="md" radius="md" withBorder h="100%">
                            ...
                            <Text size="sm" c="dimmed">
                                Top-level hub pages that can contain child pages. Your main
                                home page is a dashboard.
                            </Text>
                        </Paper>
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 4 }}>
                        <Paper p="md" radius="md" withBorder h="100%">
                            ...
                            <Text size="sm" c="dimmed">
                                Pages that show a collection or table. Can be children of a
                                dashboard.
                            </Text>
                        </Paper>
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 4 }}>
                        <Paper p="md" radius="md" withBorder h="100%">
                            ...
                            <Text size="sm" c="dimmed">
                                Pages for a specific item. These receive a URL parameter that
                                components use to filter their data.
                            </Text>
                        </Paper>
                    </Grid.Col>
                </Grid>
            ...
            <Stack gap="md">
                ...
                <Text>
                    Each page is made up of one or more <strong>components</strong>. A component
                    is a self-contained widget that displays data or provides an interface.
                    Components are stacked vertically on a page and can each be configured
                    independently.
                </Text>
            ...
            <Stack gap="md">
                ...
                <Text>
                    To customize a page, open the <strong>Page Settings</strong> drawer by
                    clicking the gear icon in the top-right corner of any page. From there you can:
                </Text>

                <List size="sm" spacing="xs">
                    <List.Item>Rename the page</List.Item>
                    <List.Item>
                        Add, remove, or reorder <strong>child pages</strong> (for dashboard/list
                        pages)
                    </List.Item>
                    <List.Item>
            ...
            <Paper p="xl" radius="md" bg="blue.0" withBorder>
                <Stack align="center" gap="md">
                    ...
                    <Text ta="center" c="dimmed">
                        Explore every available component, see what it does, try different
                        configurations in the playground, and add it directly to one of your pages.
                    </Text>
