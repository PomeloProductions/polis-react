...
export default class CollectionManagementRequests {
  ...
  static async createCollection(
    userId: number,
    collectionData: Partial<Pick<Collection, 'name' | 'is_public'>>,
  ): Promise<Collection> {
  ...
  static async createCollectionItem(
    collection: Collection,
    collectionItemData: Partial<CollectionItem>,
  ...
  static async createCollectionItemCategory(
    ...
    const { data } = await api.post(
      `/collection-items/${collectionItemId}/categories`,
      categoryData,
    );
  ...
  static async updateCollectionItemCategory(
    ...
    const { data } = await api.put(
      `/collection-item-categories/${collectionItemCategoryId}`,
      categoryData,
    );
    return data as CollectionItemCategory;
  }
