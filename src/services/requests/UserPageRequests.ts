...
export function getUserPages(userId: number): Promise<AxiosResponse<{ data: UserPage[] }>> {
...
export function deleteUserPage(userId: number, pageId: number): Promise<AxiosResponse> {
